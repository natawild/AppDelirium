...
def get_user_input_with_gasome():
    ...
    rosuvastatinaC = st.sidebar.checkbox('Rosuvastatina')
    atorvastatina = st.sidebar.slider('Atorvastatina', 0, 1, 0)
    pravastatina = st.sidebar.slider('Pravastatina', 0, 1, 0)
    sinvastatina = st.sidebar.slider('Sinvastatina', 0, 1, 0)
    fluvastatina = st.sidebar.slider('Fluvastatina', 0, 1, 0)
    alprazolam = st.sidebar.slider('Alprazolam', 0, 1, 0)
    captopril = st.sidebar.slider('Captopril', 0, 1, 0)
    codeine = st.sidebar.slider('Codeine', 0, 1, 0)
    desloratadine = st.sidebar.slider('Desloratadine', 0, 1, 0)
    diazepam = st.sidebar.slider('Diazepam', 0, 1, 0)
