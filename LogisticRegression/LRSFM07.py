...
plot_confusion_matrix(
    ...
    title="Matriz de confusão sem seleção de variáveis (RL_SFM0.7)",
)
...
pd.DataFrame.from_dict(sel.get_support()).T.to_csv("RL_SFM07_dict.csv")
...
plt.title('Variáveis selecionadas e respetiva importância (RL_SFM0.7)')
plt.show()
...
plot_confusion_matrix(
    ...
    classes=["0 - Sem Delirium", "1 - Delirium"],
    title="Matriz de confusão após seleção de variáveis (RL_SFM0.7)",
)
...
plt.xlabel('1 - Especificidade (FFP)')
plt.ylabel('Sensibilidade (FVP)')
plt.title('Curva ROC das variáveis selecionadas (RL_SFM0.7)')
# show the legend
plt.legend()
plt.show()
...
pyplot.plot(lr_recall, lr_precision, label='AUC ' + str(lr_auc))
# axis labels
pyplot.title('Curva Especificidade-Sensibilidade após seleção de variáveis (RL_SFM0.7)')
pyplot.xlabel('Sensibilidade')
pyplot.ylabel('Especificidade')
# show the legend
pyplot.legend()
...
plot_confusion_matrix(
    ...
    classes=["0 - Sem Delirium", "1 - Delirium"],
    title="Matriz de confusão após afinação dos hiperparâmetros (RL_SFM0.7",
)
...
pyplot.plot(lr_recall, lr_precision, label='AUC ' + str(lr_auc))
# axis labels
pyplot.title('Curva Especificidade-Sensibilidade após afinação (RL_SFM0.7)')
pyplot.xlabel('Sensibilidade')
pyplot.ylabel('Especificidade')
# show the legend
pyplot.legend()
...
plt.xlabel('1 - Especificidade (FFP)')
plt.ylabel('Sensibilidade (FVP)')
plt.title('Curva ROC após após afinação dos hiperparâmetros (RL_SFM0.7)')
# show the legend
plt.legend()
plt.show()
