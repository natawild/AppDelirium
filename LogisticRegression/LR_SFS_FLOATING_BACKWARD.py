...
plot_confusion_matrix(
    ...
    title="Matriz de confusão sem seleção de variáveis (RL_SFS_FLOAT_BACKWARD)",
)
...
# create a grid of parameters for the model to randomly pick and train
penalty = ["l1", "l2", "elasticnet","none"]
C = [0.0001, 0.001, 0.01, 0.1, 1, 10, 100, 1000]
max_iter = [int(x) for x in np.arange(start=1, stop=500, step=2)]
l1_ratio = [0,1]
...
plt.xlabel('1 - Especificidade (FFP)')
plt.ylabel('Sensibilidade (FVP)')
plt.title('Curva ROC após tuning (SFS_FORWARD) sem seleção de vars')
# show the legend
plt.legend()
plt.show()
...
plot_confusion_matrix(
    ...
    classes=["0 - Sem Delirium", "1 - Delirium"],
    title="Matriz de confusão após tuning sem seleção de vars (SFS_FORWARD)",
)
...
###############################################################################
#             Select most important features with LR forward                      #
###############################################################################
...
pd.DataFrame.from_dict(sel.get_metric_dict()).T.to_csv("RL_SFS_FLOAT_BACKWARD_dict.csv")
...
#Train Using Only Most Important Features
# Create a new logistic regression classifier for the most important features
clf = LogisticRegression()
...
plt.title('Variáveis selecionadas e respetiva importância (RL_SFS_FLOAT_BACKWARD)')
plt.show()
...
plot_confusion_matrix(
    ...
    classes=["0 - Sem Delirium", "1 - Delirium"],
    title="Matriz de confusão após seleção de variáveis (RL_SFS_FLOAT_BACKWARD)",
)
...
pyplot.plot(lr_recall, lr_precision, label='AUC ' + str(lr_auc))
# axis labels
pyplot.title('Curva Especificidade-Sensibilidade após seleção de variáveis (RL_SFS_FLOAT_BACKWARD)')
pyplot.xlabel('Sensibilidade')
pyplot.ylabel('Especificidade')
# show the legend
pyplot.legend()
...
plt.xlabel('1 - Especificidade (FFP)')
plt.ylabel('Sensibilidade (FVP)')
plt.title('Curva ROC das variáveis selecionadas (RL_SFS_FLOAT_BACKWARD)')
# show the legend
plt.legend()
plt.show()
...
pyplot.plot(lr_recall, lr_precision, label='AUC ' + str(lr_auc))
# axis labels
pyplot.title('Curva Especificidade-Sensibilidade após afinação (RL_SFS_FLOAT_BACKWARD)')
pyplot.xlabel('Sensibilidade')
pyplot.ylabel('Especificidade')
# show the legend
pyplot.legend()
...
plt.xlabel('1 - Especificidade (FFP)')
plt.ylabel('Sensibilidade (FVP)')
plt.title('Curva ROC após após afinação dos hiperparâmetros (RL_SFS_FLOAT_BACKWARD')
# show the legend
plt.legend()
plt.show()
...
plot_confusion_matrix(
    confusion_matrix(y_test, y_pred_best_model),
    classes=["0 - Sem Delirium", "1 - Delirium"],
    title="Matriz de confusão após afinação dos hiperparâmetros (RL_SFS_FLOAT_BACKWARD",
)
