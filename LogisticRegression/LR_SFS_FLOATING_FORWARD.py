...
plot_confusion_matrix(
    ...
    title="Matriz de confusão sem seleção de variáveis (RL_SFS_FLOAT_FORWARD)",
)
...
plt.title('Variáveis selecionadas e respetiva importância (RL_SFS_FLOAT_FORWARD)')
plt.show()
...
pd.DataFrame.from_dict(sel.get_metric_dict()).T.to_csv("RL_SFS_FLOAT_FORWARD_dict.csv")
...
plt.xlabel('1 - Especificidade (FFP)')
plt.ylabel('Sensibilidade (FVP)')
plt.title('Curva ROC das variáveis selecionadas (RL_SFS_FLOAT_FORWARD)')
# show the legend
plt.legend()
plt.show()
...
plot_confusion_matrix(
    ...
    classes=["0 - Sem Delirium", "1 - Delirium"],
    title="Matriz de confusão após seleção de variáveis (RL_SFS_FLOAT_FORWARD)",
)
...
pyplot.plot(lr_recall, lr_precision, label='AUC ' + str(lr_auc))
# axis labels
pyplot.title('Curva Especificidade-Sensibilidade após seleção de variáveis (RL_SFS_FLOAT_FORWARD)')
pyplot.xlabel('Sensibilidade')
pyplot.ylabel('Especificidade')
# show the legend
pyplot.legend()
...
pyplot.plot(lr_recall, lr_precision, label='AUC ' + str(lr_auc))
# axis labels
pyplot.title('Curva Especificidade-Sensibilidade após afinação (RL_SFS_FLOAT_FORWARD)')
pyplot.xlabel('Sensibilidade')
pyplot.ylabel('Especificidade')
# show the legend
pyplot.legend()
...
plt.xlabel('1 - Especificidade (FFP)')
plt.ylabel('Sensibilidade (FVP)')
plt.title('Curva ROC após após afinação dos hiperparâmetros (RL_SFS_FLOAT_FORWARD')
# show the legend
plt.legend()
plt.show()
...
plot_confusion_matrix(
    confusion_matrix(y_test, y_pred_best_model),
    classes=["0 - Sem Delirium", "1 - Delirium"],
    title="Matriz de confusão após afinação dos hiperparâmetros (RL_SFS_FLOAT_FORWARD",
)
