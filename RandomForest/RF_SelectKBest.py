...
from sklearn.feature_selection import SelectKBest, chi2, mutual_info_classif, f_classif, RFE, RFECV, f_regression
...
df_scores = pd.DataFrame({'features': X_train.columns, 'f_classif': results.scores_, 'pValue': results.pvalues_ })
print(df_scores)
...
print("View The Accuracy Of Our Limited Feature ", accuracy_score(y_test, y_important_pred))
