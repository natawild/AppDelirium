...
plot_confusion_matrix(
    ...
    title="Matriz de confusão sem seleção de variáveis (RF_SFS_FLOAT_BACKWARD)",
)
...
###############################################################################
#             Select most important features with RF Stepwise BACKWARD                      #
###############################################################################
...
pd.DataFrame.from_dict(sel.get_metric_dict()).T.to_csv("RF_SFS_FLOAT_BACWARD_dict.csv")
...
plt.title('Variáveis selecionadas e respetiva importância (RF_SFS_FLOAT_BACKWARD)')
plt.show()
...
plt.xlabel('1 - Especificidade (FFP)')
plt.ylabel('Sensibilidade (FVP)')
plt.title('Curva ROC das variáveis selecionadas (RF_SFS_FLOAT_BACK)')
# show the legend
plt.legend()
plt.show()
...
plot_confusion_matrix(
    confusion_matrix(y_test, y_pred),
    classes=["0 - Sem Delirium", "1 - Delirium"],
    title="Matriz de confusão após seleção de variáveis (RF_SFS_FLOAT_BACK)",
)
...
plt.xlabel('1 - Especificidade (FFP)')
plt.ylabel('Sensibilidade (FVP)')
plt.title('Curva ROC após tuning (RF-SFS_FLOAT_BACK)')
# show the legend
plt.legend()
plt.show()
...
plot_confusion_matrix(
    ...
    classes=["0 - Sem Delirium", "1 - Delirium"],
    title="Matriz de confusão após tuning (RF-SFS_FLOAT_BACK)",
)
...
pyplot.plot(lr_recall, lr_precision, label='AUC ' + str(lr_auc))
# axis labels
pyplot.title('Curva Especificidade-Sensibilidade após afinação (RF_SFS_FLOAT_BACK)')
pyplot.xlabel('Sensibilidade')
pyplot.ylabel('Especificidade')
# show the legend
pyplot.legend()
